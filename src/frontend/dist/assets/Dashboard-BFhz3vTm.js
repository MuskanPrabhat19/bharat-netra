import { c as createLucideIcon, b as commonjsGlobal, g as getDefaultExportFromCjs, r as reactExports, d as clsx, o, i as invariant, j as jsxRuntimeExports, R as Radio, S as Skeleton, C as ChartNoAxesColumn, E as Eye, e as Shield } from "./index-CL-FxwHs.js";
import { B as Badge } from "./badge-BWyjodFd.js";
import { d as useDashboard } from "./use-backend-D5H3Go86.js";
import { T as TriangleAlert, C as CircleCheckBig } from "./triangle-alert-CaM_m_4w.js";
import "./index-Cjzqe9wX.js";
/**
...
function Surface(props) {
  ...
  return /* @__PURE__ */ o.createElement("svg", _extends$s({}, filterProps(others, true, "svg"), {
...
var Layer = /* @__PURE__ */ o.forwardRef(function(props, ref) {
  ...
  return /* @__PURE__ */ o.createElement("g", _extends$r({
    className: layerClass
...
var Symbols = function Symbols2(_ref) {
  ...
  if (cx === +cx && cy === +cy && size === +size) {
    return /* @__PURE__ */ o.createElement("path", _extends$q({}, filteredProps, {
  ...
  return _createClass$k(DefaultLegendContent2, [{
    ...
    value: function renderItems() {
      ...
      return payload.map(function(entry, i) {
        ...
        return /* @__PURE__ */ o.createElement("li", _extends$p({
          className,
          style: itemStyle,
...
var DefaultTooltipContent = function DefaultTooltipContent2(props) {
  ...
  return /* @__PURE__ */ o.createElement("div", _extends$o({
    className: wrapperCN,
    style: finalStyle
...
var Text = function Text2(_ref5) {
  ...
  return /* @__PURE__ */ o.createElement("text", _extends$n({}, filterProps(textProps, true), {
    x: x2,
    y: y2,
...
function _typeof$x(o2) {
  "@babel/helpers - typeof";
  return _typeof$x = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(o22) {
    return typeof o22;
  } : function(o22) {
...
var renderRadialLabel = function renderRadialLabel2(labelProps, label, attrs) {
  ...
  return /* @__PURE__ */ o.createElement("text", _extends$l({}, attrs, {
...
function Label(_ref4) {
  ...
  return /* @__PURE__ */ o.createElement(Text, _extends$l({
...
var parseLabel = function parseLabel2(label, viewBox) {
  ...
  if (isObject$8(label)) {
    return /* @__PURE__ */ o.createElement(Label, _extends$l({
      viewBox
    }, label, {
      key: "label-implicit"
    }));
...
function LabelList(_ref) {
  ...
  return /* @__PURE__ */ o.createElement(Layer, {
    ...
    return /* @__PURE__ */ o.createElement(Label, _extends$k({}, filterProps(entry, true), others, idProps, {
...
function parseLabelList(label, data) {
  ...
  if (isObject$8(label)) {
    return /* @__PURE__ */ o.createElement(LabelList, _extends$k({
      data
    }, label, {
      key: "labelList-implicit"
    }));
...
var Sector = function Sector2(sectorProps) {
  ...
  return /* @__PURE__ */ o.createElement("path", _extends$j({}, filterProps(props, true), {
    className: layerClass,
    d: path,
    role: "img"
  }));
...
function _typeof$o(o2) {
  "@babel/helpers - typeof";
  return _typeof$o = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(o22) {
    return typeof o22;
  } : function(o22) {
    return o22 && "function" == typeof Symbol && o22.constructor === Symbol && o22 !== Symbol.prototype ? "symbol" : typeof o22;
  }, _typeof$o(o2);
...
var Rectangle = function Rectangle2(rectangleProps) {
  ...
  return /* @__PURE__ */ o.createElement(Animate, {
    ...
    }, /* @__PURE__ */ o.createElement("path", _extends$h({}, filterProps(props, true), {
      className: layerClass,
...
var Polygon = function Polygon2(props) {
  ...
  if (baseLinePoints && baseLinePoints.length) {
    ...
    return /* @__PURE__ */ o.createElement("g", {
      className: layerClass
    }, /* @__PURE__ */ o.createElement("path", _extends$g({}, filterProps(others, true), {
      fill: rangePath.slice(-1) === "Z" ? others.fill : "none",
      stroke: "none",
      d: rangePath
    })), hasStroke ? /* @__PURE__ */ o.createElement("path", _extends$g({}, filterProps(others, true), {
      fill: "none",
      d: getSinglePolygonPath(points, connectNulls)
    })) : null, hasStroke ? /* @__PURE__ */ o.createElement("path", _extends$g({}, filterProps(others, true), {
      fill: "none",
      d: getSinglePolygonPath(baseLinePoints, connectNulls)
    })) : null);
  }
  var singlePath = getSinglePolygonPath(points, connectNulls);
  return /* @__PURE__ */ o.createElement("path", _extends$g({}, filterProps(others, true), {
...
var PolarRadiusAxis = /* @__PURE__ */ function(_PureComponent) {
  ...
  return _createClass$d(PolarRadiusAxis2, [{
    ...
    value: function renderAxisLine() {
      ...
      return /* @__PURE__ */ o.createElement("line", _extends$d({
  ...
  return _createClass$c(PolarAngleAxis2, [{
    ...
    value: function renderAxisLine() {
      ...
      if (axisLineType === "circle") {
        return /* @__PURE__ */ o.createElement(Dot, _extends$c({
      ...
      return /* @__PURE__ */ o.createElement(Polygon, _extends$c({
        className: "recharts-polar-angle-axis-line"
      }, props, {
        points
      }));
    ...
    value: function renderTicks() {
      ...
      var items = ticks2.map(function(entry, i) {
        ...
        return /* @__PURE__ */ o.createElement(Layer, _extends$c({
          className: clsx("recharts-polar-angle-axis-tick", getTickClassName(tick)),
          key: "tick-".concat(entry.coordinate)
        }, adaptEventsOfChild(_this.props, entry, i)), tickLine && /* @__PURE__ */ o.createElement("line", _extends$c({
    ...
    value: function renderTickItem(option, props, value) {
      ...
      if (/* @__PURE__ */ o.isValidElement(option)) {
        ...
        tickItem = /* @__PURE__ */ o.createElement(Text, _extends$c({}, props, {
  ...
  return _createClass$b(Pie2, [{
    ...
    value: function renderSectorsStatically(sectors) {
      ...
      return sectors.map(function(entry, i) {
        ...
        return /* @__PURE__ */ o.createElement(Layer, _extends$a({
        ...
        }), /* @__PURE__ */ o.createElement(Shape, _extends$a({
    ...
    value: function renderLabelLineItem(option, props, key) {
      ...
      return /* @__PURE__ */ o.createElement(Curve, _extends$a({}, props, {
        key,
        type: "linear",
        className
      }));
    ...
    value: function renderLabelItem(option, props, value) {
      ...
      return /* @__PURE__ */ o.createElement(Text, _extends$a({}, props, {
...
var Brush = /* @__PURE__ */ function(_PureComponent) {
  ...
  return _createClass$a(Brush2, [{
    ...
    value: function renderText() {
      ...
      }, /* @__PURE__ */ o.createElement(Text, _extends$9({
        textAnchor: "end",
        verticalAnchor: "middle",
        x: Math.min(startX, endX) - offset,
        y: y2 + height / 2
      }, attrs), this.getTextOfTick(startIndex)), /* @__PURE__ */ o.createElement(Text, _extends$9({
        textAnchor: "start",
        verticalAnchor: "middle",
...
function BarRectangle(props) {
  return /* @__PURE__ */ o.createElement(Shape, _extends$8({
    shapeType: "rectangle",
  ...
  return _createClass$9(Bar2, [{
    ...
    value: function renderRectanglesStatically(data) {
      ...
      return data && data.map(function(entry, i) {
        ...
        return /* @__PURE__ */ o.createElement(Layer, _extends$7({
    ...
    value: function renderBackground() {
      ...
      return data.map(function(entry, i) {
        ...
        return /* @__PURE__ */ o.createElement(BarRectangle, _extends$7({
...
var renderLine = function renderLine2(option, props) {
  ...
  if (/* @__PURE__ */ o.isValidElement(option)) {
    ...
    line = /* @__PURE__ */ o.createElement("line", _extends$6({}, props, {
...
_defineProperty$8(ReferenceDot, "renderDot", function(option, props) {
  ...
  if (/* @__PURE__ */ o.isValidElement(option)) {
    ...
    dot = /* @__PURE__ */ o.createElement(Dot, _extends$5({}, props, {
      cx: props.cx,
      cy: props.cy,
...
_defineProperty$7(ReferenceArea, "renderRect", function(option, props) {
  ...
  if (/* @__PURE__ */ o.isValidElement(option)) {
    ...
    rect = /* @__PURE__ */ o.createElement(Rectangle, _extends$4({}, props, {
...
var CartesianAxis = /* @__PURE__ */ function(_Component) {
  ...
  return _createClass$4(CartesianAxis2, [{
    ...
    value: function renderAxisLine() {
      ...
      return /* @__PURE__ */ o.createElement("line", _extends$3({}, props, {
    ...
    value: (
      ...
      function renderTicks(ticks2, fontSize, letterSpacing) {
        ...
        var items = finalTicks.map(function(entry, i) {
          ...
          }, adaptEventsOfChild(_this2.props, entry, i)), tickLine && /* @__PURE__ */ o.createElement("line", _extends$3({}, tickLineProps, lineCoord, {
    ...
    value: function renderTickItem(option, props, value) {
      ...
      if (/* @__PURE__ */ o.isValidElement(option)) {
        ...
        tickItem = /* @__PURE__ */ o.createElement(Text, _extends$3({}, props, {
...
function toNum(v2) {
  return typeof v2 === "bigint" ? Number(v2) : v2;
}
function pct(part, total) {
  const t2 = toNum(total);
  if (t2 === 0) return "0%";
  return `${Math.round(toNum(part) / t2 * 100)}%`;
}
function formatIST(nanoTs) {
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-black uppercase tracking-widest text-muted-foreground leading-tight", children: label }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `${colorClass} shrink-0`, children: icon })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
            className: `${featured ? "text-4xl" : "text-3xl"} font-black font-mono ${colorClass} leading-none`,
            children: toNum(value).toLocaleString("en-IN")
          }
        ),
        sublabel && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground font-bold uppercase tracking-wider", children: sublabel })
      ]
    }
  );
}
function ProgressRow({ label, count, total, colorClass }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between text-sm font-bold", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground uppercase tracking-wider text-xs", children: label }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-2.5 bg-muted/50 rounded-full overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
...
function CustomTooltip({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-popover border border-border rounded-md px-3 py-2 text-xs font-bold shadow-lg", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground uppercase tracking-wider mb-1", children: label }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-foreground font-mono", children: [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-black uppercase tracking-widest text-muted-foreground px-2", children: "Primary Metrics" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px flex-1 bg-border" })
      ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px flex-1 bg-border" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-black uppercase tracking-widest text-muted-foreground px-2", children: "Analysis Breakdown" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px flex-1 bg-border" })
      ] }),
          ...
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xs font-black uppercase tracking-widest text-foreground", children: "Bias Distribution" })
              ] }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-44 -mx-2 mt-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(BarChart, { data: biasData, barCategoryGap: "35%", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  XAxis,
                  {
                    dataKey: "name",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(Bar, { dataKey: "count", radius: [4, 4, 0, 0], children: biasData.map((_entry, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Cell, { fill: biasColors[i] }, _entry.name)) })
              ] }) }) })
            ]
          }
        ),
          ...
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xs font-black uppercase tracking-widest text-foreground", children: "Classification Breakdown" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  ProgressRow,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-44 -mx-2 mt-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(PieChart, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Pie,
                  {
                    data: classData,
                    ...
                    outerRadius: 70,
                    paddingAngle: 3,
                    children: classData.map((entry) => /* @__PURE__ */ jsxRuntimeExports.jsx(Cell, { fill: entry.color }, entry.name))
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, { content: /* @__PURE__ */ jsxRuntimeExports.jsx(CustomTooltip, {}) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px flex-1 bg-border" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-black uppercase tracking-widest text-muted-foreground px-2", children: "Source Reliability" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px flex-1 bg-border" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-48", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              BarChart,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, { content: /* @__PURE__ */ jsxRuntimeExports.jsx(CustomTooltip, {}) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Bar, { dataKey: "count", radius: [0, 4, 4, 0], children: reliabilityData.map((_entry, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Cell, { fill: reliabilityColors[i] }, _entry.name)) })
                ]
              }
            ) }) })
          ] })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px flex-1 bg-border" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-black uppercase tracking-widest text-muted-foreground px-2", children: "Propaganda Analysis Summary" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px flex-1 bg-border" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row sm:items-center gap-6", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    children: toNum(stats.propaganda_alert_count).toLocaleString("en-IN")
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-black uppercase tracking-widest text-muted-foreground mt-0.5", children: "Active Propaganda Alerts" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs text-muted-foreground font-semibold mt-1", children: [
                  propagandaPct,
                  " of analyzed content"
                ] })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sm:border-l sm:border-border sm:pl-6 flex-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-black uppercase tracking-widest text-muted-foreground mb-3", children: "Detected Manipulation Types" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: PROPAGANDA_TYPES.map((t2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                Badge,
                {
                  variant: "secondary",
                  className: "text-xs font-bold uppercase tracking-wider px-3 py-1",
                  "data-ocid": `propaganda-type-${t2.key}`,
                  children: t2.label
                },
                t2.key
              )) }),
              !hasAlert && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-chart-1 font-bold mt-3 flex items-center gap-1.5", children: [
...
function Dashboard() {
  ...
  const lastRefreshed = dataUpdatedAt ? `${new Date(dataUpdatedAt).toLocaleString("en-IN", {
    timeZone: "Asia/Kolkata",
    hour: "2-digit",
    minute: "2-digit",
    second: "2-digit",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "header",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-1 h-8 bg-accent rounded-full" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl sm:text-3xl font-black tracking-tight text-foreground uppercase", children: "Intelligence Dashboard" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-black uppercase tracking-widest text-accent pl-4", children: "Bharat Netra Truth Network" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground font-semibold mt-2 pl-4", children: "Real-time aggregate truth metrics — platform-level transparency" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 shrink-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 text-xs text-muted-foreground font-semibold", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Radio, { className: "w-3.5 h-3.5 text-chart-1" }),
    ...
    isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-8", "data-ocid": "dashboard-loading", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 lg:grid-cols-4 gap-4", children: ["k1", "k2", "k3", "k4"].map((k2) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-32 rounded-lg" }, k2)) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-6", children: [
      ...
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-20 h-20 rounded-2xl bg-muted/50 border border-border flex items-center justify-center mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChartNoAxesColumn, { className: "w-10 h-10 text-muted-foreground" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-black uppercase tracking-wider text-foreground", children: "No Data Yet" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground font-semibold mt-2 max-w-sm text-sm", children: "Intelligence statistics will populate as articles are submitted and analyzed." })
        ]
      }
    ) : /* @__PURE__ */ jsxRuntimeExports.jsx(StatsGrid, { stats }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "footer",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-2 h-2 rounded-full bg-chart-1 animate-pulse" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Live monitoring active — data refreshes every 30 seconds" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
            "Frontend last polled:",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-foreground", children: lastRefreshed })
          ] })
        ]
      }
    )
